...
class ForgotUsernameForm extends StatefulWidget {
  @override
  _ForgotUsernameFormState createState() => _ForgotUsernameFormState();
}

class _ForgotUsernameFormState extends State<ForgotUsernameForm> {
        ...
        child: Form(
            ...
            child: Column(children: <Widget>[
              ...
              Container(
                  ...
                  child: Padding(
                      padding: EdgeInsets.only(
                          left: 0.20 * width, right: 0.20 * width, bottom: 30, top: 40),
                      child: Container(
                          width: 320,
                          height: 40,
                          child: RaisedButton(
